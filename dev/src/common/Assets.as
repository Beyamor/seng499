package common{
	...
	public class Assets {
		...
		[Embed(source = "../assets/map_from_hex_button.png")] public static const IMG_MAP_FROM_HEX_BUTTON:Class
		[Embed(source = "../assets/Node.png")] public static const IMG_NODE:Class
